-- ============================================================================
-- ESCRIBA POS - Base Schema (V1)
--
-- Migración base del sistema: espejo EXACTO de database/init/01-schema.sql.
--
-- Propósito:
--   * Permite que Flyway bootstrapee una base de datos VACÍA por sí solo
--     (sin depender de los init scripts del contenedor PostgreSQL).
--   * En entornos donde los init scripts ya corrieron, Flyway salta esta
--     migración vía baseline (ver baseline-version en application.yml).
--
-- Mantener SIEMPRE en sincronía con database/init/01-schema.sql.
-- ============================================================================
